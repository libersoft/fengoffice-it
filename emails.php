<?php return array(
	...
	'no smtp auth' => 'Nessuna autenticazione SMTP',
	'same as incoming' => 'Usa stesse impostazioni pop3/imap',
	...
	'format plain' => 'Formato testo semplice',
	'format html' => 'Formato HTML',
	'mail options' => 'Opzioni email',
	...
	'due_date milestone reminder desc' => 'Il traguardo "{0}" è obbligatorio in "{1}" ed è ancora da completare',
	...
	'subscribed notification email desc' => 'Sei stato iscritto all\\\'email \'{0}\' da {1}.',
        'sent mails sync' => 'Opzioni sincronizzazione posta inviata \(solo per IMAP\)',
        'connnection security' => 'Sicurezza della connessione',
        'select folder for outbox' => 'Seleziona la cartella di posta in uscita',
        ...
        'cant find user' => 'Utente richiesto non trovato',
        'cant find account' => 'Account email richiesto non trovato',
); ?>
